      ...
      <Row>
        {/* <Colxx xxs='12' xl='8' className='mb-4'>
          <Card>
            <CardBody>
              <CardTitle >
                <p id='form-components.date-picker' />
              </CardTitle>
              <label>
                <p id='form-components.date' />
              </label>
              <div className='mb-5'>
                <DatePicker
              ...
              <label>
                <p id='form-components.date-range' />
              </label>
              <Row className='mb-5'>
                <Colxx xxs='6'>
                  <DatePicker
              ...
              <label>
                <p id='form-components.date-with-time' />
              </label>
              <DatePicker
                className='mb-5'
